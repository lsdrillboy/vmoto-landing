...
export const MENU_CSS = `
    ...
    .menu-overlay {
      ...
      background:
        ...
        #080908 url('/assets/poster/menu.avif?v=2') center / cover no-repeat;
    ...
    @media (max-width: 880px) {
      ...
      /* место под бургер: 46 px кнопки + 14 px просвета до переключателя */
      .header-right { grid-column: 2; justify-self: end; margin-right: 60px; }
      .menu-fab {
        opacity: 1;
        visibility: visible;
        transform: none;
...
export const menuMarkup = ({ links, lang, label, menuAria }) => `  <button class="menu-fab" id="menuFab" aria-label="${menuAria}" aria-expanded="false">
  ...
  <div class="menu-overlay" id="menuOverlay" aria-hidden="true">
    <div class="menu-overlay__media" aria-hidden="true">
      <video id="menuVideo" src="/assets/video/menu.mp4" poster="/assets/poster/menu.avif?v=2" muted playsinline preload="none"></video>
    </div>
